...
class Label(Widget):
    ...
    def __init__(self,
        ...
        # 绘制
        self.__draw_style(self.__font,self.__bold,self.__italic,self.__underline)

        # 生成image
        self.image = self.__style.render(self.__text,self.__antialias,self.__color,self.__background)
    ...
    def __draw_style(self,font,bold,italic,underline):
        # 生成字体对象
        try:
